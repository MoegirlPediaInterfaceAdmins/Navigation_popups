...
// eslint-disable-next-line @typescript-eslint/no-unnecessary-type-conversion -- pg.re is RegExp|number; `as number` is the only legal narrowing for unary + here, the rule cannot see the pre-assertion union
